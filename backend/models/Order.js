...
//   - We store the price at time of ordering inside the order
//   - If admin changes menu price later, old orders should show original price
// - Status as enum with fixed values:
...
const orderSchema = new mongoose.Schema({
  ...
  // we have automated it by 3 seconds delay using startAutomatedProgression in the orderController.js for this Capstone demo.
  status: {
    type: String,
